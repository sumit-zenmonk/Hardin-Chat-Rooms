...
import { chatRabbitMQConfig } from "./rabbit-mq.config";
...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    private async setupInitialCreation() {
        ...
        const { queueName, exchanges } = chatRabbitMQConfig;
    ...
    async consumeMessages<TPayload = unknown>(
        ...
        await this.commonRabbitMQService.consumeMessages(this.channel, chatRabbitMQConfig.queueName, callback);
    }
