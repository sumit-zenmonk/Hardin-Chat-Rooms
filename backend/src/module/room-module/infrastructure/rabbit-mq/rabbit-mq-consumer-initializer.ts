...
@Injectable()
export class RoomRabbitMQConsumerInitializer implements OnModuleInit {
    private readonly logger = new Logger(RoomRabbitMQConsumerInitializer.name);
    ...
    async onModuleInit() {
        this.logger.log('Initializing Room RabbitMQ Consumer...');
