...
import { roomRabbitMQConfig } from "./rabbit-mq.config";
...
export class RabbitMQService implements OnModuleInit, OnModuleDestroy {
    ...
    private async setupInitialCreation() {
        ...
        const { queueName, exchanges } = roomRabbitMQConfig;
    ...
    async consumeMessages<TPayload = unknown>(
        ...
        await this.commonRabbitMQService.consumeMessages(this.channel, roomRabbitMQConfig.queueName, callback);
    }
